 ...
 * sends Key::Meta, which is Cmd on darwin and Win/Super on win32/linux.
 */
const CANONICAL_MODIFIER: Readonly<Record<string, string>> = {
  ...
  lshift: "shift",
  rshift: "shift",
  // Key::Alt and Key::Option — distinct Rust variants. We collapse aliases
  // so platform-specific blocklists can reason over one canonical modifier.
  alt: "alt",
  option: "alt",
};
...
const BLOCKED_LINUX = new Set([
  "ctrl+alt+delete", // logout / system dialog on many desktops
  "alt+f4", // close window
  "alt+tab", // window switcher
  "meta+tab", // shell/app switcher on some desktops
  "meta+l", // lock screen
  "meta+d", // show desktop
]);

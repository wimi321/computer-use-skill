...
export interface CuPermissionRequest {
  ...
  /**
   * For the "On Linux, Claude can see all apps..." footnote. Taken from
   ...
   * toggle when the grant is detected. Linux itself prompts the user to
...
export interface ComputerUseHostAdapter {
  ...
  /**
   * TCC state check — Accessibility + Screen Recording on Linux. Pure check,
 ...
 * Linux points (origin = monitor top-left, menu bar included, since
